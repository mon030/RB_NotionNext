const CONFIG = {
  ...
  LANDING_HEADER_BUTTON_1_TITLE: '服务器文档',
  LANDING_HEADER_BUTTON_1_URL: 'https://github.com/tangly1024/NotionNext',

  LANDING_HEADER_BUTTON_2_TITLE: '加入服务器',
  LANDING_HEADER_BUTTON_2_URL: 'https://blog.tangly1024.com/',

  // 首页大图英雄板块
  LANDING_HERO_TITLE_1: 'Rainbow Palace',
  LANDING_HERO_P_1: '一个位于北美的Minecraft公益正版服务器',
  LANDING_HERO_BUTTON_1_TEXT: '服务器文档',
  LANDING_HERO_BUTTON_1_LINK: 'https://docs.tangly1024.com/article/vercel-deploy-notion-next',
  LANDING_HERO_BUTTON_2_TEXT: '加入服务器',
